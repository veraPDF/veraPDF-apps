...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/apps/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/apps/ "OPF Jenkins")
