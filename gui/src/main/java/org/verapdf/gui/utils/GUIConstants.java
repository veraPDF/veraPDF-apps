...
public final class GUIConstants {
	...
	public static final String ARLINGTON_SMALL_LOGO_NAME = imgRoot + "arlington-veraPDF-small-logo.png"; //$NON-NLS-1$
	...
	public static final String CONSORTIUM_TEXT = "© 2015-2026 veraPDF Consortium"; //$NON-NLS-1$
