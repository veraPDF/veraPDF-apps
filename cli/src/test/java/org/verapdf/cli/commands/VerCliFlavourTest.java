/*
 * This file is part of VeraPDF Library CLI, a module of the veraPDF project.
 * Copyright (c) 2015-2026, veraPDF Consortium <info@verapdf.org>
 * All rights reserved.
 *
 * VeraPDF Library CLI is free software: you can redistribute it and/or modify
 * it under the terms of either:
 *
 * The GNU General public license GPLv3+.
 * You should have received a copy of the GNU General Public License
 * along with VeraPDF Library CLI as the LICENSE.GPL file in the root of the source
 * tree.  If not, see http://www.gnu.org/licenses/ or
 * https://www.gnu.org/licenses/gpl-3.0.en.html.
 *
 * The Mozilla Public License MPLv2+.
 * You should have received a copy of the Mozilla Public License along with
 * VeraPDF Library CLI as the LICENSE.MPL file in the root of the source tree.
...
public class VerCliFlavourTest {
    ...
    public final void testGetFlavourDefault() {
        // Test default is 1b
        assertSame(PDFAFlavour.NO_ARLINGTON_FLAVOUR, VeraCliArgParser.DEFAULT_ARGS.getFlavour());
